const Error = ({ error, error1, error2 }) => {
  return (
    <div
      id="alert-border-2"
      className="mt-[-30px] flex items-center p-4 mb-4 text-red-800 border-t-4 border-red-300 bg-red-50 dark:text-red-400 dark:border-red-800"
      role="alert"
    >
      <svg
